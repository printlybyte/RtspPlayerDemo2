...
package com.lgd.rtspplayerdemo2.video;
...
//	            if (DEBUG) Log.v(TAG, "encode:queueInputBuffer");
    ...
    protected void drain() {
		...
		//Log.e("hjs",""+bytesToHexString(encoderOutputBuffers.));
...
LOOP:	while (mIsCapturing) {
			...
			Log.e("hjs","mBufferInfo="+mBufferInfo);
			Log.e("hjs","encoderStatus="+encoderStatus);
