...
import com.lgd.sdtylib.CircleProgressBar;
...
public class LocalCamera extends AppCompatActivity implements View.OnClickListener
...
//                        Log.i("ACTION", "DOWN");
                    ...
                    case MotionEvent.ACTION_UP:
                        if(mTimeCount < 30){
//                            Utils.toast("不能少于3秒！");
                            Toast.makeText(LocalCamera.this, "不能少于3秒！", Toast.LENGTH_SHORT).show();
                            stopRecord();
                        } else {
                            stopRecord();
...
//                    mCamera.setParameters(parameters);// 设置相机参数
    ...
    OnRecordFinishListener recordFinishListener = new OnRecordFinishListener() {
        ...
        public void onRecordFinish() {
            Toast.makeText(LocalCamera.this, "拍摄完毕", Toast.LENGTH_SHORT).show();
        }
    };
